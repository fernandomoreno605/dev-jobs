...
export function HomePage() {
  ...
  const handleSearch = (event) => {
    ...
    const searchTerm = formData.get(inputId);
  ...
  return (
    <main>
      ...
      <section>
        <img src="/background.webp" alt="Employees background" width="200" />
        ...
        <form role="search" onSubmit={handleSearch}>
          <div>
            ...
            <input
              type="text"
              placeholder="Buscar empleos por tutulo, habilidad o empresa"
              id={inputId}
              name={inputId}
            />
      ...
      <section>
        ...
        <footer>
          ...
          <article>
            ...
            <p>Conecta con empresas que estan contratando por tus habilidades y experiencia.</p>
          </article>
          <article>
            <svg fill="currentColor" height="32" viewBox="0 0 256 256" width="32" xmlns="http://www.w3.org/2000/svg"
              aria-hidden="true">
